 ...
 * @author D E R I
 */
public class KaryawanMagang extends KaryawanAbs {
    double gajiMagang;
    ...
    void inputPosisi(String posisi) {
        this.posisi = posisi;
        this.gajiMagang = 1500000; // Contoh gaji magang
    }
    ...
    String tampilkanPosisi() {
        return "Posisi: " + posisi + ", Gaji Magang: " + gajiMagang;
    }
